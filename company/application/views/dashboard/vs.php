<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="mt-0 header-title">Verify Subscribers</h4>
            <div class="row">
                <!-- <div class="col-sm-12 text-right">
                    <button type="button" onclick="addUser()" class="btn btn-success btn-rounded w-md waves-effect waves-light mb-3"><i class="mdi mdi-plus"></i>Add User</button>
                </div> -->
            </div>
            <table id="datatable" class="table table-bordered table-hover dt-responsive nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>1st July 1982</td>
                        <td>0765345500</td>
                        <td>aloyce.mwitwa@crdbbank.co.tz</td>
                        <td>Type B</td>
                        <td>AG560</td>
                        <td>
                            <a type="submt" href="<?php echo base_url() ?>dashboard/accept" class="btn btn-xs btn-success">Accept</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" id="add-user-form">
                    ...
                    <div class="form-group">
                        <label class="text-muted">Username</label>
                        <input class="form-control" id="u-username" name="username" required>
                    </div>
                    <div class="form-group">
                        <label class="text-muted">Fullname</label>
                    ...
                    <div class="form-group">
                        <label class="text-muted">Department/Branch</label>
                        <select style="width:100%" class="form-control select2" id="u-bussnessunit" name="u-bussnessunit" required>
                            <option></option>
                            <?php
                            if (isset($data['stations']) && is_array($data['stations']) && count($data['stations']) > 0) {
                                foreach ($data['stations'] as $station) {
