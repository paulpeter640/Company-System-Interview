                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="<?php echo base_url() ?>auth/authenticate" method="POST">
                                ...
                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-success btn-block" id="login-btn" type="submit"> Log In </button>
                                    <a href="<?php echo base_url() ?>dashboard/register" class="btn btn-primary btn-block" id="login-btn-2"> Register for Agency </a>
